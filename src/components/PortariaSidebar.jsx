            ...
            <div className="flex-1 px-4 space-y-8 overflow-y-auto custom-scrollbar">
              <div>
                ...
                <nav className="space-y-1.5">
                  ...
                  <NavItem href="/portaria/pendencias" icon={IdCard} label="Pendências" active={pathname === '/portaria/pendencias'} onClick={() => setIsOpen(false)} />
                  <NavItem href="/portaria/historico" icon={Users} label="Histórico" active={pathname === '/portaria/historico'} onClick={() => setIsOpen(false)} />
                </nav>
              </div>
            </div>
