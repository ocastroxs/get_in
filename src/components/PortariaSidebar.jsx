    ...
    <>
      ...
      >
        ...
        <nav className="flex flex-col gap-2">
          <NavItem isExpanded={isExpanded} href="/portaria" icon={<Home size={20} strokeWidth={1.5} />} label="Dashboard" />
          ...
          <NavItem 
            ...
            icon={<BadgeAlert size={20} strokeWidth={1.5} />} 
            label="Pendências" 
          />
