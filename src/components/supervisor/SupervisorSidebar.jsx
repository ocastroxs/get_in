            ...
            <div className="flex-1 px-4 space-y-8 overflow-y-auto custom-scrollbar">
              <div>
                ...
                <nav className="space-y-1.5">
                  <NavItem href="/supervisor" icon={LayoutDashboard} label="Operação" active={pathname === '/supervisor'} onClick={() => setIsOpen(false)} />
                  <NavItem href="/supervisor/aprovacoes" icon={IdCard} label="Pendências" active={pathname === '/supervisor/aprovacoes'} onClick={() => setIsOpen(false)} />
                  <NavItem href="/supervisor/historico" icon={Users} label="Histórico" active={pathname === '/supervisor/historico'} onClick={() => setIsOpen(false)} />
                </nav>
              </div>
            </div>
