    ...
    <>
      ...
      >
        ...
        <div className="custom-scrollbar flex-1 space-y-8 overflow-y-auto px-4">
          <NavSection title="Fluxo de Supervisor">
            <NavItem href="/supervisor" icon={LayoutDashboard} label="Dashboard" active={pathname === '/supervisor'} onClick={() => setIsOpen(false)} />
            <NavItem href="/supervisor/aprovacoes" icon={CheckCircle2} label="Aprovações" active={pathname === '/supervisor/aprovacoes'} onClick={() => setIsOpen(false)} />
            <NavItem href="/supervisor/historico" icon={FileText} label="Histórico de Aprovações" active={pathname === '/supervisor/historico'} onClick={() => setIsOpen(false)} />
          </NavSection>
        </div>
